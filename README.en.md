...
> Images live in the `examples/` directory and are generated by this skill (see [ASSET-LICENSE.md](./ASSET-LICENSE.md)). Ten of the eleven styles have samples — imperfect collage and dot dissolve three each, editorial five (including two bilingual variants), aizome two, one for the rest; the dot paper-cut variant and tribute have none yet.
