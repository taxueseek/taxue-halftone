...
> Images live in the `examples/` directory and are generated by this skill (see [ASSET-LICENSE.md](./ASSET-LICENSE.md)). All nine styles have samples — imperfect collage and dot dissolve three each, one for the rest; the dot paper-cut variant has none yet.
...
| Sea and sky (Chinese paper-cut) |  |  |
|:---:|:---:|:---:|
| <img src="./examples/example-paper-cut-group-sea-sky.jpg" alt="Charcoal paper-cut sea, sky and fish with one pink jump-color member, Chinese paper-cut poster" width="280"> |  |  |

## Nine styles + one variant
