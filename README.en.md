...
> Images live in the `examples/` directory and are generated by this skill (see [ASSET-LICENSE.md](./ASSET-LICENSE.md)). One per style; imperfect collage has three.
...
- **v1.0.0** (2026-09-01): Initial release. Seven styles, seven print mechanisms, machine validation, and evaluation cases. See [CHANGELOG.md](./CHANGELOG.md).
