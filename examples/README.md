...
本目录存放由技能实际出图产出的示例海报，十二种风格与两个变体中十个有样张（不完美印刷拼贴三张、点阵解构三张、复古编辑五张含双语变体两张、蓝染两张、其余风格各一张）；经典致敬、波普波点与两种变体（点阵剪纸、物影蓝晒）暂无样张。
...
| `example-echo.png` | 回声 · 实验电影 | 波兰海报（polish） |
| `example-seashell.png` | 海风集 · zine 封面 | 孔版小册（riso_zine） |
| `example-rain-umbrella.png` | 雨天雨伞 | 不完美印刷拼贴（imperfect_collage） |
| `example-night-walk.png` | 城市夜归 | 不完美印刷拼贴（imperfect_collage） |
| `example-night-ride.png` | 夜骑 | 不完美印刷拼贴（imperfect_collage） |
